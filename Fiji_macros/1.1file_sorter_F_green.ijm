...
for (i=0; i<n1; i++) {
	...
	if (startsWith(title, "Green Uncalibrated_F2_1")) {
		saveAs("Tiff", F02_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F2_2")) {
		saveAs("Tiff", F02_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F2_3")) {
		saveAs("Tiff", F02_03 + title);
	}	
	
	//----
	
	if (startsWith(title, "Green Uncalibrated_F3_1")) {
		saveAs("Tiff", F03_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F3_2")) {
		saveAs("Tiff", F03_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F3_3")) {
		saveAs("Tiff", F03_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_F4_1")) {
		saveAs("Tiff", F04_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F4_2")) {
		saveAs("Tiff", F04_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F4_3")) {
		saveAs("Tiff", F04_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_F5_1")) {
		saveAs("Tiff", F05_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F5_2")) {
		saveAs("Tiff", F05_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F5_3")) {
		saveAs("Tiff", F05_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_F6_1")) {
		saveAs("Tiff", F06_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F6_2")) {
		saveAs("Tiff", F06_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F6_3")) {
		saveAs("Tiff", F06_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_F7_1")) {
		saveAs("Tiff", F07_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F7_2")) {
		saveAs("Tiff", F07_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F7_3")) {
		saveAs("Tiff", F07_03 + title);
	}	
	//----	
	if (startsWith(title, "Green Uncalibrated_F8_1")) {
		saveAs("Tiff", F08_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F8_2")) {
		saveAs("Tiff", F08_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F8_3")) {
		saveAs("Tiff", F08_03 + title);
	}	
	//----	
	if (startsWith(title, "Green Uncalibrated_F9_1")) {
		saveAs("Tiff", F09_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F9_2")) {
		saveAs("Tiff", F09_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F9_3")) {
		saveAs("Tiff", F09_03 + title);
	}	
	//----	
	if (startsWith(title, "Green Uncalibrated_F10_1")) {
		saveAs("Tiff", F10_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F10_2")) {
		saveAs("Tiff", F10_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F10_3")) {
		saveAs("Tiff", F10_03 + title);
	}
	//----	
	if (startsWith(title, "Green Uncalibrated_F11_1")) {
		saveAs("Tiff", F11_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F11_2")) {
		saveAs("Tiff", F11_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_F11_3")) {
