...
for (i=0; i<n1; i++) {
	...
	if (startsWith(title, "Green Uncalibrated_C2_1")) {
		saveAs("Tiff", C02_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C2_2")) {
		saveAs("Tiff", C02_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C2_3")) {
		saveAs("Tiff", C02_03 + title);
	}	
	
	//----
	
	if (startsWith(title, "Green Uncalibrated_C3_1")) {
		saveAs("Tiff", C03_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C3_2")) {
		saveAs("Tiff", C03_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C3_3")) {
		saveAs("Tiff", C03_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_C4_1")) {
		saveAs("Tiff", C04_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C4_2")) {
		saveAs("Tiff", C04_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C4_3")) {
		saveAs("Tiff", C04_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_C5_1")) {
		saveAs("Tiff", C05_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C5_2")) {
		saveAs("Tiff", C05_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C5_3")) {
		saveAs("Tiff", C05_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_C6_1")) {
		saveAs("Tiff", C06_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C6_2")) {
		saveAs("Tiff", C06_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C6_3")) {
		saveAs("Tiff", C06_03 + title);
	}	
	//----	
	
	if (startsWith(title, "Green Uncalibrated_C7_1")) {
		saveAs("Tiff", C07_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C7_2")) {
		saveAs("Tiff", C07_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C7_3")) {
		saveAs("Tiff", C07_03 + title);
	}	
	//----	
	if (startsWith(title, "Green Uncalibrated_C8_1")) {
		saveAs("Tiff", C08_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C8_2")) {
		saveAs("Tiff", C08_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C8_3")) {
		saveAs("Tiff", C08_03 + title);
	}	
	//----	
	if (startsWith(title, "Green Uncalibrated_C9_1")) {
		saveAs("Tiff", C09_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C9_2")) {
		saveAs("Tiff", C09_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C9_3")) {
		saveAs("Tiff", C09_03 + title);
	}	
	//----	
	if (startsWith(title, "Green Uncalibrated_C10_1")) {
		saveAs("Tiff", C10_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C10_2")) {
		saveAs("Tiff", C10_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C10_3")) {
		saveAs("Tiff", C10_03 + title);
	}
	//----	
	if (startsWith(title, "Green Uncalibrated_C11_1")) {
		saveAs("Tiff", C11_01 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C11_2")) {
		saveAs("Tiff", C11_02 + title);
	}	
	if (startsWith(title, "Green Uncalibrated_C11_3")) {
